...
public class Monster extends AbstractMovingObject {
	...
	if (DDRemix.getApplication().getMode() != Application.STATUS_BATTLE) {
	    ...
	    DDRemix.getApplication().getMazeManager().getMaze().postBattle(this, dirX, dirY, true);
	}
    }
	...
	DDRemix.getApplication().getMazeManager().getMaze().updateMonsterPosition(move, dirX, dirY, this);
	this.activateTimer(1);
    }
