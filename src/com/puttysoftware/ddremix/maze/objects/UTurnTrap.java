...
public class UTurnTrap extends AbstractTrap {
	...
	DDRemix.getApplication().showMessage("Your controls are turned around!");
	DDRemix.getApplication().getGameManager().activateEffect(MazeEffectConstants.EFFECT_U_TURNED);
