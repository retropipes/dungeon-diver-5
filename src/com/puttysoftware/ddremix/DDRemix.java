...
public class DDRemix {
	...
	CommonDialogs.showErrorDialog(DDRemix.ERROR_MESSAGE, DDRemix.ERROR_TITLE);
	Diane.handleError(t);
    }

    public static void preInit() {
	// Compute action cap
	AbstractCreature.computeActionCap(DDRemix.BATTLE_MAZE_SIZE, DDRemix.BATTLE_MAZE_SIZE);
    }
