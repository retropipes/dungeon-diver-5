...
class PreferencesGUIManager {
	...
	if (vwSize != newSize) {
	    DDRemix.getApplication().getGameManager().viewingWindowSizeChanged();
	...
	this.loadPrefs();
	// HiDPI detection
	final Object o = Toolkit.getDefaultToolkit().getDesktopProperty("apple.awt.contentScaleFactor");
	if (o != null) {
	    // OS X
