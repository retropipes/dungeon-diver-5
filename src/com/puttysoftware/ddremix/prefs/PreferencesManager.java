...
public class PreferencesManager {
	...
	return PreferencesManager.storeMgr.getBoolean(PreferencesManager.HD_SETTING, false);
    }

    public static void setHighDefEnabled(final boolean value) {
	PreferencesManager.storeMgr.setBoolean(PreferencesManager.HD_SETTING, value);
    }
	...
	try (BufferedInputStream bis = new BufferedInputStream(
	    ...
	    PreferencesManager.storeMgr.setBoolean(PreferencesManager.HD_SETTING, false);
